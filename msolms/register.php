...
<body class="hold-transition">
  ...
  <div class="d-flex justify-content-center align-items-center flex-row h-70 mt-10">
        <div class="col-5">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group input-group-sm">
                                    <input type="password" id="password" name="password" pattern="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$" class="form-control form-control-sm form-control-border" required>
