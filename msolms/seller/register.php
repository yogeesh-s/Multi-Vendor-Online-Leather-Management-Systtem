        ...
        <div class="col-7 h-100 bg-gradient-light px-4">
            <div class="d-flex justify-content-center align-items-center w-100 h-100">
                <div class="card card-outline card-primary col-12 rounded-0 shadow">
                    ...
                    <form id="sregister-frm" action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="contact" name="contact" pattern="[7-9]{1}[0-9]{9}" class="form-control form-control-sm form-control-border" required>
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="row">
                            ...
                            <!--<div class="form-group col-md-6">
                                <label for="username" class="control-label">Emaili</label>
                                <input type="email" id="email" name="email" pattern="[a-z0-9]+@[a-z]+\.[a-z]{2,3}" class="form-control form-control-sm form-control-border" required>
                            </div>-->
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group input-group-sm">
                                    <input type="password" id="password" pattern="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$" name="password" class="form-control form-control-sm form-control-border" required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group input-group-sm">
                                    <input type="password" id="cpassword" pattern="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$" class="form-control form-control-sm form-control-border" required>
                                    <div class="input-group-append bg-transparent border-top-0 border-left-0 border-right-0 rounded-0">
                                        <span class="input-group-text bg-transparent border-top-0 border-left-0 border-right-0 rounded-0">
                                            <a href="javascript:void(0)" class="text-reset text-decoration-none pass_view"> <i class="fa fa-eye-slash"></i></a>
                                        </span>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="file" id="logo" name="img" class="form-control form-control-sm form-control-border" onchange="displayImg(this,$(this))" accept="image/png, image/jpeg, image/jpg" required>
                            </div>
                        </div>
                        <div class="row">
...
<script>
  ...
  $(function(){
    ...
    $('#sregister-frm').submit(function(e){
        e.preventDefault();
        var _this = $(this)
            $('.err-msg').remove();
        var el = $('<div>')
        ...
        start_loader();
        $.ajax({
            url:_base_url_+"classes/Users.php?f=save_seller",
