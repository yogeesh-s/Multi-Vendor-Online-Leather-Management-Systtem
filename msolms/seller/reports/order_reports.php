                ...
                <div class="callout callout-primary shadow rounded-0">
                    ...
                    <table class="table table-bordered table-stripped">
                        ...
                        <tbody>
                            ...
                            $i = 1;
                            $total = 0;
                            $orders = $conn->query("SELECT o.*,c.code as ccode, CONCAT(c.lastname, ', ',c.firstname,' ',COALESCE(c.middlename,'')) as user from `order_list` o inner join user_list c on o.user_id = c.id where o.seller_id = '{$_settings->userdata('id')}' and date_format(o.date_created,'%Y-%m') = '{$month}' order by unix_timestamp(o.date_created) desc ");
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-right align-middle px-2 py-1">₹ <?php echo format_num($row['status']!=5?$row['total_amount']:0) ?></td>
                                </tr>
                            <?php endwhile; ?>
                        </tbody>
                        <tfoot>
