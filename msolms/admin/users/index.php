        ...
        <div class="container-fluid">
			<table class="table table-bordered table-stripped">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT *,CONCAT(lastname, ', ', firstname,' ', COALESCE(middlename)) as `name` from `user_list` where delete_flag = 0 order by CONCAT(lastname, ', ', firstname,' ', COALESCE(middlename)) asc ");
					...
					?>
						<tr>
							...
							<td class="text-center">
								...
								<?php else: ?>
									<span class="badge badge-success bg-gradient-danger px-3 rounded-pill">Inactive</span>
								<?php endif; ?>
							</td>
							<td align="center">
