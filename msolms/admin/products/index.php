        ...
        <div class="container-fluid">
			<table class="table table-bordered table-stripped">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT p.*,v.code, v.shop_name as `seller` from `product_list` p inner join seller_list v on p.seller_id = v.id where p.delete_flag = 0 order by p.`name` asc ");
					...
					?>
						<tr>
							...
							<td>
								<div class="border-bottom text-truncate"><?= $row['code'].'-'.$row['seller'] ?></div>
