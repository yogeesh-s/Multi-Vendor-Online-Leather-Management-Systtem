...
<!-- Navbar -->
      ...
      <nav class="w-100 px-2 py-1 position-fixed top-0 bg-primary text-light" id="login-nav">
            ...
            <?php if($_settings->userdata('id') > 0 && $_settings->userdata('login_type') ==3): ?>
              <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  ...
                  <a class="dropdown-item" href="<?= base_url.'classes/Login.php?f=logout_user' ?>">Logout</a>
                </div>
              </div>
            <?php else: ?>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <?php 
                $cart_count = $conn->query("SELECT sum(quantity) FROM `cart_list` where user_id = '{$_settings->userdata('id')}'")->fetch_array()[0];
